...
export function NotificationBell() {
    ...
    return (
        <div className="notification-bell-container" ref={dropdownRef} style={{ position: 'relative', display: 'inline-block' }}>
            ...
            {isOpen && (
                <div className="absolute top-full mt-2 left-1/2 -translate-x-1/2 w-[360px] max-h-[480px] bg-white rounded-xl shadow-2xl z-50 overflow-hidden border border-slate-100">

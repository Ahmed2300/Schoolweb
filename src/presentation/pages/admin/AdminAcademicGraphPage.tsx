...
const NodeWrapper = ({
    ...
    <div className={`relative px-4 py-3 shadow-md rounded-xl bg-white border-2 ${borderColor} min-w-[200px] transition-all duration-200 ${isLoading ? 'opacity-70' : ''}`}>
        {children}
        {isLoading && (
...
const GradeNode = ({ data }: { data: any }) => {
    return (
        <NodeWrapper isLoading={data.isLoading} borderColor="border-indigo-500">
...
const SemesterNode = ({ data }: { data: any }) => {
    return (
        <NodeWrapper isLoading={data.isLoading} borderColor="border-emerald-500">
...
const SubjectNode = ({ data }: { data: any }) => {
    return (
        <NodeWrapper isLoading={data.isLoading} borderColor="border-amber-500">
...
const CourseNode = ({ data }: { data: any }) => {
    return (
        <NodeWrapper isLoading={false} borderColor="border-slate-400">

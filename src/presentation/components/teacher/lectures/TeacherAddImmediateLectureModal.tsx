                ...
                >
                    <div className="flex min-h-full items-center justify-center p-4">
                        <motion.div
                            ...
                            className="bg-white dark:bg-[#1E1E1E] rounded-3xl w-full max-w-2xl max-h-[90dvh] flex flex-col shadow-card hover:shadow-card-hover text-right border border-slate-200 dark:border-white/5 overflow-hidden"
                        >

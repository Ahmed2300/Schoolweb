    ...
    return (
        <div className="container mx-auto px-4 py-8 pb-32 animate-pulse">
            ...
            <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm mb-8 relative overflow-hidden">
                ...
                <div className="flex gap-4 mt-8 border-b border-slate-100 pb-1">
                    {[1, 2, 3, 4].map((i) => (
                        <div key={i} className="h-8 w-24 bg-slate-200 rounded-t-lg"></div>
                    ))}
                </div>
            </div>
                        ...
                        <div key={i} className="bg-white rounded-xl border border-slate-200 overflow-hidden">
                            <div className="p-4 flex items-center justify-between">
                                <div className="flex items-center gap-3 flex-1">
                                    <div className="w-5 h-8 bg-slate-200 rounded"></div>
                                    <div className="w-10 h-10 bg-slate-200 rounded-lg"></div>
